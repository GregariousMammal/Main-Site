...
blogger_author:
  - Cate Lawrence
blogger_permalink:
  - /2014/10/jackfruit-bournignon.html
blogger_internal:
  - /feeds/4126609572633548921/posts/default/4611462303447223733
tags:
  - cooking
  - recipe
  - vegan
...
<span style="font-family: 'Helvetica Neue', Arial, Helvetica, sans-serif;"><br /> 
  ...
  * <span style="font-family: 'Helvetica Neue', Arial, Helvetica, sans-serif;">2 cans jackfruit 
...
<ol style="margin-top: 0cm;" start="1" type="1">
  ...
  <li style="mso-list: l0 level1 lfo1; tab-stops: list 36.0pt;">
    Heat 1 tablespoon of oil and fry the jackfruit on both sides until it is lightly browned. Remove from the pan and place in a bowl. The fruit with come apart and can be shredded.
  </li>
  <li style="mso-list: l0 level1 lfo1; tab-stops: list 36.0pt;">
    Add 1 tablespoon of olive oil to a large pot and cook the mushrooms until they start to brown. 
  </li>
  <li style="mso-list: l0 level1 lfo1; tab-stops: list 36.0pt;">
    Add the carrots, celery, onion, thyme, salt and pepper  and cook for 10 minutes, stirring occasionally, until the onions are lightly browned. 
  </li>
  <li style="mso-list: l0 level1 lfo1; tab-stops: list 36.0pt;">
    Add the garlic and cook for another minute.
  </li>
  <li style="mso-list: l0 level1 lfo1; tab-stops: list 36.0pt;">
    Add the wine to the pot, scraping any stuck bits off the bottom, then turn the heat all the way up and reduce it by half. Stir in the tomato paste and the vegetable stock. 
  </li>
  <li style="mso-list: l0 level1 lfo1; tab-stops: list 36.0pt;">
    Return the jackfruit to the pot.
  </li>
  <li style="mso-list: l0 level1 lfo1; tab-stops: list 36.0pt;">
    Once the liquid has boiled, reduce the temperature so it simmers for 30 minutes, or until mushrooms are tender and the mix has a stew like appearance.
  </li>
  <li style="mso-list: l0 level1 lfo1; tab-stops: list 36.0pt;">
    Sprinkle corn flour into the mix and stir well. 
  </li>
  <li style="mso-list: l0 level1 lfo1; tab-stops: list 36.0pt;">
    Lower the heat and simmer for 10 more minutes. If the sauce is too thin, boil it down to reduce to the right consistency. Season to taste with salt and pepper.
  </li>
</ol>
