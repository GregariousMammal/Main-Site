...
**Astrid Lorenzen from [Hamburg FabLab](http://www.fablab-hamburg.org/).**
...
[XYZ Bike](http://www.xyzcargo.com/) that people can create and assemble themselves.
...
**Benjamin Tincq from [OuiShare](http://ouishare.net/en)**
...
The new space for the sharing economy to investigate is collaborative production, moving beyond collaborative consumption, for example [The People's Supermarket](http://thepeoplessupermarket.org/).

Bike sharing schemes, Co-Working spaces all help reduce travel impacts on the environment. Also the [WikiSpeed](http://wikispeed.org/) open source car that aims to be as efficient as possible through agile production methods.

**Tony Greenham from the [New Economics Foundation](http://www.neweconomics.org/people/entry/tony-greenham) and [Transition Network](http://www.transitionnetwork.org/)**
...
A great transport example is one from [Bristol in the UK](http://www.thebristolbikeproject.org/) where old bike parts are refurbished into new bikes. Workers are from poorer backgrounds who learn new skills and gain experience. This then spreads bike usage and all the positive affects of that.

[Brixton energy](http://brixtonenergy.co.uk/) is a scheme that has been installing communal solar panels onto social housing that can be cheap enough for many to buy into, even if it's a small amount.
